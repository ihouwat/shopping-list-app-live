      ...
      storeCategories: [
        {
          ...
          category: 'Deli',
          items: [
            'Bacon', 'Beef', 'Bleu cheese', 'Catfish', 'Cheddar', 'Cheese', 
            'Chicken', 'Cottage cheese', 'Crab', 'Cream cheese', 'Goat cheese', 
            'Ground beef ', 'Ham', 'Hummus', 'Lobster', 'Meat', 'Pork', 'Provolone', 
            'Ricotta', 'Salmon', 'Sausage', 'Shrimp', 'Tilapia', 'Tinned meats', 'Tuna', 
            'Turkey', 'Blue cheese', 'Cod', 'Deli meat', 'Feta cheese', 'Ground turkey', 
            'Halibut', 'Hamburger', 'Jack cheese', 'Steak', 'Swiss cheese', 'Gouda cheese',
            'Paczki', 'Pastries','Croissants', 'Donuts','Cake'
          ]
        },
        {
          storeOrder: 2,
          category: 'Snacks & Freezer',
          items: [
            'Almonds', 'Candy', 'Chip dip', 'Chips', 'Club soda / Tonic', 'Crackers', 
            'Hot sauce', 'Ice cream', 'Pop', 'Popcorn', 'Popsicles', 'Pretzels', 'Relish', 
            'Salsa', 'Sports drink', 'Steak sauce', 'Veggie burgers', 'Baked tortilla chips', 
            'Brazil nuts', 'Candy / Gum', 'Cashews', 'Celery seed', 'Chestnuts', 'Chocolate', 
            'Dark chocolate', 'Diet soft drinks', 'Dip', 'Dried fruit / Trail mix', 
            'Electrolyte water', 'Energy drinks', 'Fruit snacks', 'Gum', 'Horseradish', 
            'Hot chocolate mix', 'Macadamia', 'Peanuts', 'Pecans', 'Pine nuts', 'Pistachios', 
            'Potato chips', 'Soda pop', 'Soft drinks', 'Sorbet', 'Tomato sauce', 'Tortilla chips', 
            'Tortillas (corn)', 'Tortillas (flour)', 'Walnuts', 'Water chestnuts'
          ]
        },
        {
          storeOrder: 3,
          category: 'Fridges',
          items: [
            'Beer', 'Butter', 'Champagne', 'Eggs', 'Fish sticks', 'Fruit juice', 'Gin', 
            'Half & half', 'Margarine', 'Milk', 'Mixers', 'Mozzarella ', 'Orange Juice', 
            'Rum', 'Sake', 'Sandwich slices', 'Sour cream', 'Vodka', 'Whiskey', 'Wine', 
            'Yogurt', 'Almond milk', 'Butter / Soy butter', 'Cream', 'Egg substitute', 
            'Free-range eggs', 'Juice', 'Liquor', 'Rice milk', 'Tempeh', 'Veggie dogs', 
            'Apple Cider'
          ]
        },
        {
          ...
          items: [
            ...
            'Glass cleaner', 'Glue', 'Greeting card', 'Insect repellent', 'Light bulbs', 'Mop head', 
            'Napkins', 'Notepad', 'Paper towels', 'Pencils', 'Pens', 'Pet shampoo', 'Plastic wrap', 
            'Postage stamps', 'Printer paper', 'Propane', 'Sandwich bags', 'Sponge', 'Tape', 
            'Toilet paper', 'Wax paper', 'Wipes', 'Cups', 'Diaper cream', 'Dishwasher', 'Dog food', 
        ...
        },
        {
          ...
          items: [
            'Cherry juice concentrate', 'Chicken bites', 'Fries / Tater tots', 'Frozen berries', 
            'Frozen vegetables', 'Frozen veggie meat', 'Lasagna', 'Veggie burritos', 'Veggie pizzas'
          ]
        },
        {
          storeOrder: 7,
          category: 'Pantry',
          items: [
            'Applesauce', 'BBQ sauce', 'Bouillon cubes', 'Bread crumbs', 'Burritos', 'Chocolate Chips', 
            'Cinnamon', 'Cocoa', 'Coffee', 'Coffee filters', 'Cookies', 'Dried fruit', 'Farro', 
            'Flaxseed', 'Gravy', 'Hot dogs', 'Instant potatoes', 'Jam', 'Ketchup', 'Mac & cheese', 
            'Mayonnaise', 'Mustard', 'Nuts', 'Oatmeal', 'Parmesan', 'Pasta', 'Pasta sauce', 
            'Peanut butter', 'Pickles', 'Pita bread', 'Pizza', 'Rice', 'Tea', 'TV dinners', 
            'Waffle Mix', 'Whipped cream', 'Anise', 'Baby cereal', 'Barley', 'Brown lentils', 
            'Brown rice', 'Buckwheat', 'Bulgur', 'Burger helper', 'Canned fruit', 'Canned milk', 
            'Chai', 'Chickpeas', 'Couscous', 'Creamed corn', 'Green lentils', 'Grits', 'Indian pouches', 
            'Kombucha', 'Lentils', 'Lima beans', 'Macaroni', 'Millet', 'Noodle mix', 'Olives (black)', 
            'Olives (green)', 'Pinto beans', 'Pizza dough', 'Prepared meals', 'Quinoa', 'Rice mix', 
            'Soup', 'Soup mix', 'Soups', 'Spaghetti', 'Spelt', 'Sun-dried tomatoes', 'Sweet & sour', 
            'Waffles', 'White rice', 'Wild rice', 'Falafel', 'Baking powder', 'Baking soda', 
            'Brownie mix', 'Cake icing / Decorations', 'Cake mix', 'Flour', 'Honey', 'Olive oil', 
            'Olives', 'Oregano', 'Pancake mix', 'Paprika', 'Salt', 'Soy sauce', 'Spice mix', 'Sugar', 
            'Sugar substitute', 'Syrup', 'Vanilla extract', 'Vegetable oil', 'Vinegar', 
            'Worcestershire sauce', 'Yeast', 'Agave nectar', 'Allspice', 'Almond butter', 
            'Apple cider vinegar', 'Balsamic vinegar', 'Broth', 'Brown rice syrup', 'Brownies', 
            'Bullion cubes', 'Cake / Brownie mix', 'Cake decor', 'Chili powder', 'Clove', 'Cloves', 
            'Cocktail sauce', 'Cooking wine', 'Coriander', 'Cornmeal', 'Cornstarch', 'Croutons', 'Cumin', 
            'Curry', 'Flax', 'Food coloring', 'Frosting', 'Garlic powder', 'Garlic salt', 'Gelatin', 
            'Harissa', 'Italian seasoning', 'Lemon pepper seasoning', 'Maple syrup', 'Marinade', 'Marjoram', 
            'Mayo product', 'Muffin mix', 'Nonstick cooking spray', 'Nutmeg', 'Nutritional yeast', 
            'Pancake / Waffle mix', 'Phyllo / Puff pastry', 'Pie crust', 'Pie filling', 'Ponzu', 'Poppy seed', 
            'Prunes / Raisins', 'Pudding', 'Raisins', 'Red wine vinegar', 'Rice vinegar', 'Rosemary', 'Saffron', 
            'Sage', 'Seasoned salt', 'Seeds', 'Sesame oil', 'Spearmint', 'Sriracha', 'Stevia', 'Stir fry sauce', 
            'Sugar (brown)', 'Tahini', 'Tarragon', 'Tartar sauce', 'Teriyaki', 'Tumeric', 'TVP', 'Vanilla', 
            'Veg. Worcestershire', 'Vegetable broth', 'Vegetable shortening', 'Wheat gluten (Seitan)', 
            'Whipped topping', 'White vinegar', 'Grapeseed oil', 'Garam Masala'
          ]
        },
        {
          storeOrder: 8,
          category: 'Beans & Health Foods',
          items: [
            'Baked beans', 'Black Beans', 'Cereal', 'Cereal Bars', 'Chili', 'Cliff Bars', 
            'Granola bars', 'Granola mix', 'Hot dogs', 'Tofu', 'Amaranth', 'Beans', 
            'Black-eyed peas', 'Cannellini beans', 'Fava beans', 'Graham crackers', 
            'Granola / Cereal bars', 'Kidney beans', 'Navy beans', 'Red beans', 'Sorghum', 'White beans'
          ]
        },
        {
          storeOrder: 9,
          category: 'Bakery',
          items: [
            'Bagels', 'Bread ', 'Buns / Rolls',  'English muffins', 
             'Bagels / Croissants', 'Biscuits', 'Dinner rolls', 
            'Hot dog buns', 'Muffins', 'Pie',
          ]
        },
        {
          storeOrder: 10,
          ...
          items: [
            'Apples', 'Asparagus', 'Avocados', 'Bananas', 'Basil', 'Berries', 'Black pepper', 
            'Blueberries', 'Broccoli', 'Carrots', 'Cauliflower', 'Celery', 'Cherries', 'Cilantro', 
            'Clementines', 'Corn', 'Cucumbers', 'Flowers', 'Fruit', 'Garlic', 'Ginger', 'Grapefruit', 
            'Grapes', 'Greens', 'Lemons ', 'Lettuce', 'Lime juice', 'Limes', 'Melon', 'Mint',
            'Mushrooms', 'Nectarines', 'Onions', 'Oranges', 'Parsley', 'Peaches', 'Pears', 
            'Peppers', 'Plums', 'Potatoes', 'Red pepper', 'Salad dressing', 'Spinach',
            'Squash', 'Tomatoes', 'Vegetables', 'Zucchini', 'Apricots', 'Artichoke', 
            'Artichokes', 'Arugula', 'Baby carrots ', 'Bamboo shoots', 'Bay leaves', 
            'Beets', 'Bell peppers', 'Blackberries', 'Bok choy', 'Brussels sprouts',
            'Cabbage', 'Cantelope', 'Cassava', 'Cayenne pepper', 'Chard', 'Chilies',
            'Chives', 'Coleslaw ', 'Collard greens', 'Cranberries', 'Crisphead lettuce', 
            'Cucumber', 'Daikon', 'Dates', 'Dill', 'Edamame', 'Eggplant', 'Endive',
            'Fennel', 'Figs', 'Garlic cloves', 'Green onions', 'Guava', 'Honeydew / Muskmelon', 
            'Hot peppers', 'Jicama', 'Kale', 'Kiwi', 'Kohlrabi', 'Kumquats', 'Leaf lettuce',
            'Lemongrass', 'Lychee', 'Mango', 'Mangosteen', 'Nopales', 'Okra', 'Papaya', 
            'Peas', 'Pepper', 'Peppermint', 'Pineapple', 'Plantains', 'Pomegranate', 
            'Portobello mushrooms ', 'Pumpkin', 'Quince', 'Radicchio', 'Radishes', 
            'Raspberries', 'Red grapes ', 'Rhubarb', 'Romaine lettuce', 'Salad greens', 
            'Shallots / Leeks', 'Split peas', 'Sprouts', 'Strawberries', 'Sweet potatoes ',
            'Taro', 'Thyme', 'Tomatillo', 'Turnips / Parsnips', 'Watercress',
            'Watermelon', 'Truffles'
          ]
        },
        {
